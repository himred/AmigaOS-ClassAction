...
/****************************************
	...
	Goal     : Try to open the xfdmaster.library
...
/****************************************
	...
	Goal     : Close the xfdmaster Library
...
/****************************************
	...
	Goal     : Decrunch the buffer 'buff'
			   of len 'buflen' and return
			   the pointer of the decrunched
			   buffer. Initialize 'cruncher'
			   to the used decruncher and
			   'newlen' with the len of the
			   decrunched buffer
