...
#define CA_MOVE 52
#define CA_DELETE 53
#define CA_OPTIONS 54
#define CA_DEL_OK 55
#define CA_ACTIONS 56
#define CA_MANAGE 57
...
#define CA_DIR_STR "Directory"
#define CA_BLIST_STR "Path buttons"
#define CA_MLIST_STR "Main Directory List"
#define CA_TPATH_STR "Current working directory"
#define CA_VOLS_STR "List of volumes and assigns"
#define CA_PARENT_STR "Go to the parent directory"
#define CA_FNAME_STR "Name of the selected file"
#define CA_CNAME_STR "Class of the selected file"
#define CA_ALIST_STR "List of available actions\nfor the selected file"
#define CA_PREFS_STR "Prefs"
#define CA_PREFSH_STR "Launches ClassActionPrefs\n\nIf this not work check the value\nof the tooltype CAPREFS"
#define CA_ABOUTH_STR "Display Information and version of ClassAction"
#define CA_QUITH_STR "Quit ClassAction"
#define CA_DEST_STR "Destination"
#define CA_COPY_STR "Copy"
#define CA_RENAME_STR "Rename"
#define CA_MKDIR_STR "MakeDir"
#define CA_CLONE_STR "Copy As"
#define CA_MOVE_STR "Move"
#define CA_DELETE_STR "Delete"
#define CA_OPTIONS_STR "Options"
#define CA_DEL_OK_STR "Ok to delete selected entries ?"
#define CA_ACTIONS_STR "Actions"
#define CA_MANAGE_STR "Managing"
...
static const struct CatCompArrayType CatCompArray[] =
{
    ...
    {CA_DIR,(STRPTR)CA_DIR_STR},
    {CA_BLIST,(STRPTR)CA_BLIST_STR},
    {CA_MLIST,(STRPTR)CA_MLIST_STR},
    {CA_TPATH,(STRPTR)CA_TPATH_STR},
    {CA_VOLS,(STRPTR)CA_VOLS_STR},
    {CA_PARENT,(STRPTR)CA_PARENT_STR},
    {CA_FNAME,(STRPTR)CA_FNAME_STR},
    {CA_CNAME,(STRPTR)CA_CNAME_STR},
    {CA_ALIST,(STRPTR)CA_ALIST_STR},
    {CA_PREFS,(STRPTR)CA_PREFS_STR},
    {CA_PREFSH,(STRPTR)CA_PREFSH_STR},
    {CA_ABOUTH,(STRPTR)CA_ABOUTH_STR},
    {CA_QUITH,(STRPTR)CA_QUITH_STR},
    {CA_DEST,(STRPTR)CA_DEST_STR},
    {CA_COPY,(STRPTR)CA_COPY_STR},
    {CA_RENAME,(STRPTR)CA_RENAME_STR},
    {CA_MKDIR,(STRPTR)CA_MKDIR_STR},
    {CA_CLONE,(STRPTR)CA_CLONE_STR},
    {CA_MOVE,(STRPTR)CA_MOVE_STR},
    {CA_DELETE,(STRPTR)CA_DELETE_STR},
    {CA_OPTIONS,(STRPTR)CA_OPTIONS_STR},
    {CA_DEL_OK,(STRPTR)CA_DEL_OK_STR},
    {CA_ACTIONS,(STRPTR)CA_ACTIONS_STR},
    {CA_MANAGE,(STRPTR)CA_MANAGE_STR},
};
...
static const char CatCompBlock[] =
{
    ...
    "\x00\x00\x00\x0B\x01\x00"
    CA_COPYRIGHT_STR "\x00"
    ...
    CA_ACTIONS_STR "\x00"
    "\x00\x00\x00\x39\x00\x0A"
    CA_MANAGE_STR "\x00\x00"
};
